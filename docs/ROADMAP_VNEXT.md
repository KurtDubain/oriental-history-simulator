...
> 任务状态：Phase A 已完成；Phase B 已交付三类权威 Situation、事实型结案层与 B10 局势全卷，B09 数值化起止快照因权威字段缺失继续保留；Phase C 的 C01/C02 已完成 Situation-first 题源与三问连续性仲裁，下一观察纵切是 C03/C04 的局势关注与里程碑暂停，人物 Agency 尚未开始
...
- [ ] **C03 — 关注 Situation**：观察台持久化 situation ID，而非只关注代理人物/政权；当前卡片关注仍明确标为“关注对象”。
- [ ] **C04 — 自动暂停**：milestone、phase change、核心人物死亡和结案触发；当前战争、权力更替、疫病、重要史事与对象命中暂停不能冒充 Situation 里程碑暂停。
...
- Situation 卡片点击可直达对应局势全卷；卡片展示起始纪年、追踪季度、最近转折和下一观察。对象关注沿用既有代理实体契约，C03 的 Situation ID 关注与 C04 的 Situation milestone 自动暂停均明确留待下一纵切。
...
15. [ ] 下一纵切：C03/C04，让观察台真正关注 Situation ID，并按形成、阶段变化、核心人物死亡和结案里程碑暂停；人物 Agency 仍不在这一纵切内。
...
下一轮的演示目标是：玩家关注一条 Situation 后，自动推演能在它形成、升级、核心人物死亡或结案时准确暂停，并可从暂停原因直达同一卷宗。
...
- 不立即铺开 B05/B07 等更多检测器；下一轮先完成 C03/C04，让已经稳定可读的 Situation 成为真正可关注、可按里程碑暂停的观察对象。
- 不把三问卡片当前的“关注对象”或普通史事自动暂停描述成 Situation 级关注/里程碑暂停；这两项必须以 C03/C04 的稳定 Situation ID 契约验收。
- 不先做完整围城 UI。
- 不先增加宗教、文化、资源、兵种或地图。
