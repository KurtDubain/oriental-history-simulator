...
> 建立于 2026-08-27，v1.27.1 战局展示收口于 2026-09-06，命令：`npm run test:audit:architecture`

## 当前规模

- `src` 下生产 TypeScript / TSX：171 个文件，61,782 行（测试排除）。v1.27.1 只收紧眼下大事、战争卷、编队展开与地图语义锚点，没有新增状态 owner、页面或模拟阶段。
