...
2026-09-08 未发布模拟修订：生产171文件、62,142行，相对上述 UI 工作树62,093行增加49行；App 2,220行不变、engine 3,100行（减少18行）、observer-leads 399行不变。679依赖（runtime441、type-only238）不变，运行时环0，所有现有架构预算通过。个人/参赛JS gzip均424,942 bytes（+1,212），CSS39,653不变；预算424,960/40,960不提高。新增代码复用军令、Battle Fact、外交、宰辅职位和人物经历所有权；不新增 WorldState 字段、schema、季度阶段或依赖。
