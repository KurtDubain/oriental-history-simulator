...
function hasConcreteAction(text: string): boolean {
  return /开战|交战|取胜|守住|停战|议和|占得上风|易手|接管|争取|答应|观望|请领|请掌|应允|安抚|削权|撤去|受任|出任|去职|去世|成婚|暂缓|未准|推举|推为|继任|离任|离开领袖位置|更换领袖|退出朝局|结成盟约|退出[^：。]{0,12}权力中枢|清洗|发动宫变|篡立新朝/u.test(text);
}
